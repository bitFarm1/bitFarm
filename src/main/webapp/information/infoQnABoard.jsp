...
<table border="1" class="QnAtable" cellpadding="5px">  
	...
	<tr>
		...
		<td style="text-align: left;"><input class="layoutT" type="text" name="subject">&emsp;
			<input class="layoutB" type="button" value="주문조회"></td>
	</tr>	
	<tr>
		<td class="title">이메일</td>
		<td style="text-align: left;"><input class="layoutT" type="text" name="subject"></td>
	</tr>	
	<tr>
	...
	<tr>
		...
		<textarea style="margin: 0px; width: 670px; height: 460px;"></textarea>
		</td> 		
	</tr>
	<tr>
		<td class="title">파일 선택</td>
		<td style="text-align: left;"><input class="layoutT" id="upload1" type="file" name="upload1" size="50"></td>
	</tr> 
</table> 
